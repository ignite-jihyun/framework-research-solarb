...
package com.ignite.graphql.examples.server.spring.instrumentation

import com.ignite.graphql.examples.server.spring.directives.TRACK_TIMES_INVOKED_DIRECTIVE_NAME
...
/**
 * Adds field count tracking in the instrumentation layer if [com.ignite.graphql.examples.directives.TrackTimesInvoked] is present.
 */
@Component
